...
parser.add_argument('--is_cropped', action='store_true',  #corp the frame?
...
parser.add_argument("--FCN", action="store_false",
                    help="Whether to use a dense validation/test approach. If not set, center crop approach will be used")
...
def main(args):
    ...
    #---------------------------------------------training
        ...
        for epoch in range(args.start_epoch, args.epochs):
                ...
                # train for one epoch
                print('--------start training epoach {}'.format(epoch))
                ...
                time.sleep(1)
                print('--------finish training epoach {}'.format(epoch))
                
                # evaluate on validation set
                print('--------start validating epoach {}'.format(epoch))
                ...
                print('--------finish validating epoach {}'.format(epoch))
